...
Similarity score is calculated using 3 variables: **speedMatchScore**, **lengthDiff** and **lengthMatchInd** defined as follow:

```{r, echo=FALSE}
knitr::include_graphics("C:/Users/yijdi/OneDrive/Desktop/trips_data/formula.png")
```
